...
export default function Sidebar({category, onSelectionChange}) {
  return (
    <div class="w-60 h-full shadow-md bg-gray-100 px-1">
          <div class="text-left font-bold text-bold uppercase text-gray-500 ml-4 p-2">Category</div>  
      <hr class="mb-2"/>    
      <ul class="relative">
        <li class="relative" onClick={()=>onSelectionChange('Payment')}>
          <span
        ...
        <li class="relative" onClick={()=>onSelectionChange('Banking')}>
          <span
            class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out"
            href="#!"
            data-mdb-ripple="true"
        ...
        <li class="relative" onClick={()=>onSelectionChange('CEFI')}>
          <span
            class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out"
            href="#!"
            data-mdb-ripple="true"
